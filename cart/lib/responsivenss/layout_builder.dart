...
class MyResponsivenss1 extends StatefulWidget {
  const MyResponsivenss1({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MyResponsivenss1> createState() => _MyResponsivenss1State();
}

class _MyResponsivenss1State extends State<MyResponsivenss1> {
